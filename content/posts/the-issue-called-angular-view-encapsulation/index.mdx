...
Why does this need to be so hard? It's an issue for many, that's been around for over two years without a definitive solution. In particular, when it comes to customising material design components where a component is composed of other material design components.
